 ...
 */
export declare function Hexagon(props: HexagonProps & Omit<React.SVGProps<SVGGElement>, "transform" | "onDrop" | "onDragOver" | "onMouseEnter" | "onClick" | "onMouseMove" | "onMouseLeave" | "onMouseUp" | "onMouseDown">): React.JSX.Element;
